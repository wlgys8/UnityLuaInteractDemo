...
namespace KeraLua
{
    ...
    public class Lua : IDisposable
    {
        ...
        {
            return NativeMethods.lua_newuserdatauv(_luaState, (uint) size, uv);
        }
        ...
        public void PushBuffer(byte[] buffer)
        {
            ...
            NativeMethods.lua_pushlstring(_luaState, buffer, (uint)buffer.Length);
        }
        ...
        {
            return NativeMethods.lua_stringtonumber(_luaState, s) != 0;
        }
...
#pragma warning restore IDE0018 // Inline variable declaration
        ...
        {
            return (LuaStatus)NativeMethods.luaL_loadbufferx(_luaState, buffer, (uint)buffer.Length, name, mode);
        }
